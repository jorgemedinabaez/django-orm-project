...
class ModeloAuto(models.Model):
    ...
    f_fabricacion = models.IntegerField(choices=annos_choices,default=anno_actual,verbose_name='Fecha de fabricación')
    costo_fabricacion = models.DecimalField(null=False,decimal_places=2,max_digits=10,verbose_name='Costo de fabricación')
